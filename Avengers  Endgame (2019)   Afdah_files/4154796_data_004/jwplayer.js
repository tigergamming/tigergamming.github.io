window.jwplayer = function(e) {
    ...
    var i, r;
    i = [], r = function() {
        return "7.12.4+commercial_v7-12-4.191.commercial.9f64bf.jwplayer.4c1b7b.freewheel.a63b67.googima.356b98.vast.94a27d.analytics.cbd53f.plugin-gapro.7e936b.plugin-related.7adae3.plugin-sharing.586630.vr-plugin.725b2e.hls.js.";
    }.apply(t, i), !(void 0 !== r && (e.exports = r))
}, function(e, t, n) {
    var i, r;
            ...
            setup: function(o, m) {
                ...
                function A() {
                    ...
                    e && e.on("nextUp", function(e) {
                        fe.set("nextUp", e)
                    }), se.once(v.JWPLAYER_RESIZE, C), se.init()
                }

                function C() {
                    fe.change("visibility", k), fe.on("change:controls", b), ge.trigger(v.JWPLAYER_READY, {
                        setupTime: 0
                ...
                function x(e, t) {
                    switch (fe.get("state") === g.ERROR && fe.set("state", g.IDLE), fe.set("preInstreamState", "instream-idle"), ge.trigger("destroyPlugin", {}), D(!0), fe.off("itemReady", L), "undefined" == typeof e ? "undefined" : a(e)) {
                        case "string":
                            fe.once("itemReady", L), T(e);
                            break;
                        case "object":
                            fe.once("itemReady", L);
                            var n = J(e, t);
